...
export default function SuperUserFeedbackPage() {
  ...
  useEffect(() => {
    const fetchFeedbackOpportunities = async () => {
      try {
        ...
        console.log("Final feedback opportunities (superuser):", opportunities);
  ...
  const filteredOpportunities = feedbackOpportunities.filter((opportunity) => {
    const matchesSearch = opportunity.teacher.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         ...
                         opportunity.observerName.toLowerCase().includes(searchTerm.toLowerCase());
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-700">Observer: {opportunity.observerName}</span>
                        </div>
                        <div className="flex items-center gap-2">
                      ...
                      {opportunity.status === 'approved' || opportunity.status === 'revised' ? (
                        <div className="flex gap-2">
                          <Button
                            ...
                            asChild
                          >
                            <Link href={`/super/feedback/${opportunity.observationId}`}>
                          ...
                          <Button
                            ...
                            asChild
                          >
                            <Link href={`/super/feedback/${opportunity.observationId}/edit`}>
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            asChild
                          >
                            <Link href={`/super/observations/${opportunity.observationId}`}>
                              <Eye className="h-4 w-4 mr-2" />
                              View Observation
                            </Link>
                          </Button>
