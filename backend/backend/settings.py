...
SECRET_KEY = 'django-insecure-t*38384b-yw+l1^rehi#s4(b(-+25#lmfn2c4xqw^d0_7$xp$i'
...
# Use custom user model defined in the `auths` app
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://tet-bloom-gamma.vercel.app"
]
